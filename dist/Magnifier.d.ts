...
export default class Magnifier extends PureComponent<Props, State> {
    ...
    onTouchEnd: () => void;
    calcImgBounds: () => void;
    render: () => React.ReactElement<any, string | ((props: any, deprecatedLegacyContext?: any) => React.ReactElement<any, any> | null) | (new (props: any, deprecatedLegacyContext?: any) => React.Component<any, any, any>)>;
}
export {};
